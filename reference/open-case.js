// REFERENCIA INERTE, no se ejecuta en ningun html actual. Rescatado de app-v1.html (borrado, ver ADR 0001)
// como punto de partida para migrar la caja abierta a index.html. Depende de reference/open-case.css
// y de un shape de pelicula tipo js/movie-source.js. render()/setOnSpineClick() son de los lomos viejos,
// prescindibles; lo que importa es openCase() y sus helpers (buildOverlayContent, booklet*, discSvg).
